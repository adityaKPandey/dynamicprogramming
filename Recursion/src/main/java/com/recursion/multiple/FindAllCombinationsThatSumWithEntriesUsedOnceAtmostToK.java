...
public class FindAllCombinationsThatSumWithEntriesUsedOnceAtmostToK {
  ...
  public void findAllCombinationsThatSumToKWithEachEntryUsedAtmostOnce(long[] input, long k, int index,
      LinkedList<Long> thisCombination, Collection<LinkedList<Long>> allCombinations) {
      ...
      allCombinations.add(new LinkedList<>(thisCombination));
       ...
       for(int i = index ; i < input.length ; i++){
            if( (i > index && input[i] == input[i-1]) ){
              ...
              findAllCombinationsThatSumToKWithEachEntryUsedAtmostOnce(input , k - input[i] , i+1 , thisCombination , allCombinations);
              thisCombination.removeLast();
            }
       }
  ...
  public static void main(String[] args) {
    ...
    findAllCombinationsThatSumToK.findAllCombinationsThatSumToKWithEachEntryUsedAtmostOnce(input1, 10, 0, new LinkedList<>(),
        allCombinationsSet);
    ...
    findAllCombinationsThatSumToK.findAllCombinationsThatSumToKWithEachEntryUsedAtmostOnce(input2, 8, 0, new LinkedList<>(),
        allCombinationsSet);
    System.out.println(allCombinationsSet);
    ...
    Arrays.sort(input3);
    allCombinationsSet = new ArrayList<>();
    findAllCombinationsThatSumToK.findAllCombinationsThatSumToKWithEachEntryUsedAtmostOnce(input3, 7, 0, new LinkedList<>(),
        allCombinationsSet);
    System.out.println(allCombinationsSet);
    ...
    Arrays.sort(input4);
    allCombinationsSet = new ArrayList<>();
    findAllCombinationsThatSumToK.findAllCombinationsThatSumToKWithEachEntryUsedAtmostOnce(input4, 7, 0, new LinkedList<>(),
        allCombinationsSet);
    System.out.println(allCombinationsSet);
    ...
    Arrays.sort(input5);
    allCombinationsSet = new ArrayList<>();
    findAllCombinationsThatSumToK.findAllCombinationsThatSumToKWithEachEntryUsedAtmostOnce(input5, 29, 0, new LinkedList<>(),
        allCombinationsSet);
    System.out.println(allCombinationsSet);
    ...
    Arrays.sort(input6);
    allCombinationsSet = new ArrayList<>();
    findAllCombinationsThatSumToK.findAllCombinationsThatSumToKWithEachEntryUsedAtmostOnce(input6, 10, 0, new LinkedList<>(),
        allCombinationsSet);
    System.out.println(allCombinationsSet);
    ...
    Arrays.sort(input7);
    allCombinationsSet = new ArrayList<>();
    findAllCombinationsThatSumToK.findAllCombinationsThatSumToKWithEachEntryUsedAtmostOnce(input7, 10, 0, new LinkedList<>(),
        allCombinationsSet);
    System.out.println(allCombinationsSet);
